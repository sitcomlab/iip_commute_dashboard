...
function SvgPendlerKarteWithStations(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      style={{
        fillRule: 'evenodd',
    ...
    >
      ...
      <g transform="matrix(.61412 0 0 .60358 256.874 158.75)">
        ...
        <g clipPath="url(#Pendler_Karte_With_Stations_svg__a)">
          <path
      ...
      <g transform="matrix(.61412 0 0 .60358 189.746 264.518)">
        ...
        <g clipPath="url(#Pendler_Karte_With_Stations_svg__b)">
          <path
            d="M58 4c0-2.208-1.792-4-4-4H4C1.792 0 0 1.792 0 4v14c0 2.208 1.792 4 4 4h50c2.208 0 4-1.792 4-4V4Z"
            style={{
              fill: 'none',
...
export default SvgPendlerKarteWithStations
